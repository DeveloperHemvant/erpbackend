...
export class StudentsController {
  ...
  updateParentCredentials(@Param("id", ParseUUIDPipe) id: string, @Body() dto: UpdateParentCredentialsDto) {
  ...
  setupParentPortal(@Param("id", ParseUUIDPipe) id: string, @Body() dto: SetupParentPortalDto) {
