...
export class EmsController {
  ...
  createRoom(@Param("scheduleId") scheduleId: string, @Body() data: CreateExamRoomDto) {
  ...
  generateSeating(@Param("roomId") roomId: string, @Body() data: GenerateSeatingDto) {
    return this.emsService.generateSeating(roomId, data);
  }

  // --- Invigilators ---
  @Post("rooms/:roomId/invigilators")
  createInvigilator(@Param("roomId") roomId: string, @Body() data: CreateInvigilatorDto) {
  ...
  createQuestion(@Param("questionBankId") questionBankId: string, @Body() data: CreateQuestionDto) {
  ...
  addQuestionToPaper(@Param("id") id: string, @Body() data: AddQuestionPaperItemDto) {
  ...
  activateOnlineSchedule(@Param("id") id: string, @Body() data: ActivateOnlineScheduleDto) {
  ...
  @RequirePermissions()
  startOnlineAttempt(@Param("attemptId") attemptId: string, @CurrentUser() user: AuthenticatedUser) {
    return this.emsService.startOnlineAttempt(attemptId, user);
  }

  @Get("attempts/:attemptId/paper")
  @RequirePermissions()
  getAttemptPaper(@Param("attemptId") attemptId: string, @CurrentUser() user: AuthenticatedUser) {
  ...
  @RequirePermissions()
  submitOnlineAttempt(@Param("attemptId") attemptId: string, @CurrentUser() user: AuthenticatedUser) {
    return this.emsService.submitOnlineAttempt(attemptId, user);
  }

  // --- Exam Attempts ---
  @Post("schedules/:scheduleId/attempts/generate")
  generateAttempts(@Param("scheduleId") scheduleId: string, @Body() data: GenerateAttemptsDto) {
  ...
  createModeration(@Param("scheduleId") scheduleId: string, @Body() data: CreateModerationDto) {
