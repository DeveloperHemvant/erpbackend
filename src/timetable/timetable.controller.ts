...
export class TimetableController {
  ...
  @Get("substitutes")
  @ApiOperation({ summary: "Suggest available substitute teachers for a period" })
  getSubstituteSuggestions(
    ...
    return this.timetableService.getSubstituteSuggestions(dayOfWeek, startTime, endTime, subjectId);
  }
